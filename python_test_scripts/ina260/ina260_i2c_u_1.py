...
chip0 = ina260_ui.INA260_UI(chip = '0#0x45', time = 1, u_unit = 'mV', mode = ina260_constant.register.MODE_BUS_VOLT_CONT, avgc = ina260_constant.register.COUNT_16)
sens0 = ina260.conf_register_list(address = 0x45)
