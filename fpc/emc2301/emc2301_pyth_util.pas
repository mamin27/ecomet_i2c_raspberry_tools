...
begin
  ...
  if (keys[2] = 'CONF')
   ...
   begin
    ...
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[31];                  //'GAINP'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[32];
    ...
    Ob_emc_attr[idx_emc_attr].attr_name:=keys[33];                      //'FAN_STAT'
    Ob_emc_attr[idx_emc_attr].attr_val_selector:=true;
    emc.attr2:=Ob_emc_attr[idx_emc_attr];
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[34];                  //'WATCH'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[35];
    Ob_emc_c[idx_emc_c].attr1:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[36];                  //'DRIVE_FAIL'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[37];
    Ob_emc_c[idx_emc_c].attr2:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[38];                  //'DRIVE_FAIL_I'
