...
chip0 = ina260_ui.INA260_UI(chip = '0#0x44', time = 1, v_unit = 'mV', i_unit = 'mA', mode = ina260_constant.register.MODE_CUR_VOLT_CONT, 
                                      avgc = ina260_constant.register.COUNT_1, vbusct = ina260_constant.register.TIME_204_us, ishct = ina260_constant.register.TIME_204_us)
chip1 = ina260_ui.INA260_UI(chip = '1#0x45', time = 1, v_unit = 'mV', mode = ina260_constant.register.MODE_BUS_VOLT_CONT, 
