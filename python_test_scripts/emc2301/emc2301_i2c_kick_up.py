...
#TEST
#sens.write_register(register = 'TACH_COUNT', value = 1000)
#sens.write_register(register = 'FAN_FAIL_BAND', value = 30)
#sens.write_register(register = 'TACH_TARGET', value = 100)
#sens.write_register(register = 'FAN_MIN_DRIVE', value = 102 )
#sens.write_register(register = 'SOFTWARE_LOCK', bits = ['LOCK_CLR'] )
#sens.write_register(register = 'FAN_SPIN_UP', bits = ['FAN_SPIN_UP_NOKICK'], bit = fan_list['FAN_SPIN_UP_NO_SPIN'] )
#sens.write_register(register = 'FAN_SPIN_UP', bits = ['FAN_SPIN_UP_NOKICK'], bit = fan_list['FAN_SPIN_UP_SPIN'] )
#sens.write_register(register = 'SOFTWARE_LOCK', bits = ['LOCK'] )
