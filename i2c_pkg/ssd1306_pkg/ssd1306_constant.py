...
class register(object):
    ...
    SET_ENTIRE_DISP_ON	= 0xA4		# Set Entire Display ON
    SET_ENTIRE_DISP_OFF	= 0xA5		# Set Entire Display OFF
    ...
    SET_OUTPUT_SCAN_FROM= 0xC0		# Scan common output allowing layout flexible, (from COM0 -> COM[n-1])
    SET_OUTPUT_SCAN_TO	= 0xC8		# Scan common output allowing layout flexible, (from COM[n-1] -> COM0) 
