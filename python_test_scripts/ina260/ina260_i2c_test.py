...
from ecomet_i2c_sensors.ina260	import ina260,ina260_constant
...
buf = {}
(buf,size) = measure2.measure_voltage(stime = 10)
measure2._logger.info("Size: %s", size)
measure2._logger.info("Buff: %s", buf)
