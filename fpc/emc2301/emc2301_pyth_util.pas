...
//  writeln('String: ' + emc_str);
  ...
  if (keys[2] = 'CONF')
   ...
   begin
    ...
    Ob_emc_c[idx_emc_c].attr2:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[40];                  //'DRIVE_FAIL_I'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[41];
    Ob_emc_c[idx_emc_c].attr3:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[42];                  //'FAN_SPIN'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[43];
    Ob_emc_c[idx_emc_c].attr4:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[44];                  //'FAN_STALL'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[45];
    Ob_emc_c[idx_emc_c].attr5:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[46];                  //'FAN_INT'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[47];
    Ob_emc_c[idx_emc_c].attr6:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[48];                  //'FAN_SETTING'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[49];
    Ob_emc_c[idx_emc_c].attr7:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    ...
    Ob_emc_attr[idx_emc_attr].attr_name:=keys[50];                      //'SPIN'
    Ob_emc_attr[idx_emc_attr].attr_val_selector:=true;
    emc.attr3:=Ob_emc_attr[idx_emc_attr];
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[51];                  //'DRIVE_FAIL_CNT'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[52];
    Ob_emc_c[idx_emc_c].attr1:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[53];                  //'NOKICK'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[54];
    Ob_emc_c[idx_emc_c].attr2:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[55];                  //'SPIN_LVL'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[56];
    Ob_emc_c[idx_emc_c].attr3:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[57];                  //'SPINUP_TIME'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[58];
    Ob_emc_c[idx_emc_c].attr4:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[59];                  //'FAN_MAX_STEP'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[60];
    Ob_emc_c[idx_emc_c].attr5:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[61];                  //'FAN_MIN_DRIVE'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[62];
    Ob_emc_c[idx_emc_c].attr6:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_attr[idx_emc_attr].attr_val_obj:=Ob_emc_c[idx_emc_c];
    ...
    Ob_emc_attr[idx_emc_attr].attr_name:=keys[63];                      //'PWM'
    Ob_emc_attr[idx_emc_attr].attr_val_selector:=true;
    emc.attr4:=Ob_emc_attr[idx_emc_attr];
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[64];                  //'PWM_POLARITY'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[65];
    Ob_emc_c[idx_emc_c].attr1:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[66];                  //'PWM_OUTPUT'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[67];
    Ob_emc_c[idx_emc_c].attr2:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[68];                  //'PWM_BASE'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[69];
    Ob_emc_c[idx_emc_c].attr3:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[70];                  //'PWM_DIVIDE'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[71];
    Ob_emc_c[idx_emc_c].attr4:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_attr[idx_emc_attr].attr_val_obj:=Ob_emc_c[idx_emc_c];
    ...
    Ob_emc_attr[idx_emc_attr].attr_name:=keys[72];                      //'TACH'
    Ob_emc_attr[idx_emc_attr].attr_val_selector:=true;
    emc.attr5:=Ob_emc_attr[idx_emc_attr];
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[73];                  //'TACH_COUNT'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[74];
    Ob_emc_c[idx_emc_c].attr1:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[75];                  //'FAN_FAIL_BAND'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[76];
    Ob_emc_c[idx_emc_c].attr2:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[77];                  //'TACH_TARGET'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[78];
    Ob_emc_c[idx_emc_c].attr3:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[79];                  //'TACH_READ'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[80];
    Ob_emc_c[idx_emc_c].attr4:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_attr[idx_emc_attr].attr_val_obj:=Ob_emc_c[idx_emc_c];
    ...
    Ob_emc_attr[idx_emc_attr].attr_name:=keys[81];                      //'ID'
    Ob_emc_attr[idx_emc_attr].attr_val_selector:=true;
    emc.attr6:=Ob_emc_attr[idx_emc_attr];
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[82];                  //'PRODUCT_ID'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[83];
    Ob_emc_c[idx_emc_c].attr1:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[84];                  //'MANUF_ID'
    Ob_emc_c_attr[idx_emc_c_attr].attr_val:=keys[85];
    Ob_emc_c[idx_emc_c].attr2:=Ob_emc_c_attr[idx_emc_c_attr];
    idx_emc_c_attr := idx_emc_c_attr +1;
    Ob_emc_c_attr[idx_emc_c_attr].attr_name:=keys[86];                  //'REVISION_ID'
